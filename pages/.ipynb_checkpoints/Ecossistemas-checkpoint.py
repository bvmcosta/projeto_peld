...
with st.container(border = True):
    ...
    st.markdown("""<p style='text-align: justify'> Entre 2020 e 2025, os impactos antrópicos sobre ecossistemas marinhos, estuarinos e dulcícolas inseridos na 
    Área de Proteção Ambiental de Guadalupe foram avaliados pelos pesquisadores do <a href="https://www.ufpe.br/organomar">Laboratório de Compostos Orgânicos 
    em Ecossistemas Costeiros e Marinhos (OrganoMAR - UFPE)</a>. O impacto antrópico através de uma fonte pontual (e.g., estação de tratamento de esgoto) ou 
    difusa (e.g., queima de biomassa vegetal no continente) pode ser avaliado através da concentração de poluentes em matrizes ambientais (e.g, água, 
    sedimento, biota).</p>
                """, 
